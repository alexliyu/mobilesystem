...
APPLICATIONS = [
    ...
    Application('mobile.molly.apps.desktop', 'desktop', 'Desktop',
        display_to_user=True,
    ...
    Application('mobile.molly.apps.feedback', 'feedback', 'Feedback',
        display_to_user=True,
    ),
    
    Application('mobile.molly.apps.feature_vote', 'feature_vote', 'Feature suggestions',
        display_to_user=True,
    ),
