...
from baseutils.http import MediaType, HttpResponseSeeOther
from baseutils.simplify import (simplify_value, simplify_model,
                                  serialize_to_xml)
...
def handler500(request):
    ...
    try:
        from baseutils.context_processors import ssl_media
