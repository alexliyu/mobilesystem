...
class GoogleMapsFormWidget(widgets.Widget):
    ...
    class Media:
        js = ('http://maps.google.com/maps/api/js?sensor=false', 'http://code.jquery.com/jquery.min.js', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.9/jquery-ui.min.js', '/media/admin/js/admin.js',)
        css = {
