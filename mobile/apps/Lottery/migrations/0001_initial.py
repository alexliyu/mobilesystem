...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Lottery_lottery', (
            ...
            ('Lottery_title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('addTime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('Lottery', ['Lottery'])

        # Adding M2M table for field User on 'Lottery'
        db.create_table('Lottery_lottery_User', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lottery', models.ForeignKey(orm['Lottery.lottery'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('Lottery_lottery_User', ['lottery_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field User on 'Lottery'
        db.delete_table('Lottery_lottery_User')


    models = {
        'Lottery.lottery': {
            'Lottery_title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
