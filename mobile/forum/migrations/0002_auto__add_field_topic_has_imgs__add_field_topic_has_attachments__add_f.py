...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_topic', 'has_imgs', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Topic.has_attachments'
        db.add_column('forum_topic', 'has_attachments', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Topic.level'
        db.add_column('forum_topic', 'level', self.gf('django.db.models.fields.SmallIntegerField')(default=30), keep_default=False)

        # Adding field 'Post.has_imgs'
        db.add_column('forum_post', 'has_imgs', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Post.has_attachments'
        db.add_column('forum_post', 'has_attachments', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.has_imgs'
        db.delete_column('forum_topic', 'has_imgs')

        # Deleting field 'Topic.has_attachments'
        db.delete_column('forum_topic', 'has_attachments')

        # Deleting field 'Topic.level'
        db.delete_column('forum_topic', 'level')

        # Deleting field 'Post.has_imgs'
        db.delete_column('forum_post', 'has_imgs')
