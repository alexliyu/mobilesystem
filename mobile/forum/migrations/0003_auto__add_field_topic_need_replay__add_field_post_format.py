...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_topic', 'need_replay', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Post.format'
        db.add_column('forum_post', 'format', self.gf('django.db.models.fields.CharField')(default='bbcode', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.need_replay'
        db.delete_column('forum_topic', 'need_replay')

        # Deleting field 'Post.format'
        db.delete_column('forum_post', 'format')
