...
from mobile.molly.conf import app_by_application_name
from mobile.molly.auth.models import UserIdentifier, UserSession, ExternalServiceToken
from mobile.molly.favourites.models import Favourite
