...
from mobile.molly.utils.http import MediaType, HttpResponseSeeOther
from mobile.molly.utils.simplify import (simplify_value, simplify_model,
                                  serialize_to_xml)
from mobile.molly.utils.breadcrumbs import NullBreadcrumb
...
def ReverseView(request):
    from mobile.molly.auth.views import SecureView
...
def handler500(request):
    ...
    try:
        from mobile.molly.wurfl.context_processors import device_specific_media
    ...
    try:
        from mobile.molly.utils.context_processors import ssl_media
