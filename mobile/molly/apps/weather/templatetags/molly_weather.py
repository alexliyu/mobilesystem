...
from mobile.molly.apps.weather.models import Weather
from mobile.molly.conf.applications import app_by_application_name
...
class WeatherNode(template.Node):
    ...
    def render(self, context):
        ...
        try:
            context[self.name] = Weather.objects.get(location_id=app_by_application_name('molly.apps.weather').location_id)
