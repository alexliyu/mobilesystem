...
from mobile.molly.external_media import sanitise_html
from mobile.molly.conf.settings import batch

from mobile.molly.apps.feeds.providers import BaseFeedsProvider
...
class RSSFeedsProvider(BaseFeedsProvider):
    ...
    def import_data(self, metadata, output):
        ...
        from mobile.molly.apps.feeds.models import Feed
    ...
    def import_feed(self, feed):
        from mobile.molly.apps.feeds.models import Item
